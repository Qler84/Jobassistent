...
export function LogoFull({ className = 'h-auto w-full max-w-xs' }) {
  return <img src="/logo-full.png" alt="JobAssistent - smartes Bewerbungsmanagement" className={`${className} object-contain`} />
}
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <div>
        ...
        {showTagline && <p className="text-xs text-slate-400 -mt-0.5">smartes Bewerbungsmanagement</p>}
      </div>
    </div>
  )
}
