...
Unveraendert aus der Desktop-App uebernommen (siehe dortiges
core/email_imap.py fuer die ausfuehrliche Begruendung von BODY.PEEK[],
Multi-Ordner-Suche und dem READ-ONLY-Ordner-Workaround)."""
...
KEYWORDS_EINLADUNG = [
    "vorstellungsgespraech", "vorstellungsgespräch", "einladen", "kennenlernen",
    "gespraechstermin", "gesprächstermin", "interview",
]
KEYWORDS_ABSAGE = [
    "absage", "leider", "andere kandidat", "andere bewerber",
    "nicht beruecksichtigen", "nicht berücksichtigen", "abgesagt",
]
